...
stdenv.mkDerivation rec {
  ...
  buildPhase = ''
    ...
    # For home-manager compatibility
    hmChromeHosts=$out/etc/chromium/native-messaging-hosts

    mkdir -p "$hostDir" "$firefoxHosts" "$chromeHosts" "$hmChromeHosts"
    ...
    cp "$chromeHosts/$APP_NAME.json" "$hmChromeHosts/"
