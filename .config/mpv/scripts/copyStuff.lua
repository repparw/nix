...
mp.add_key_binding("y", "copyFilename", copyFilename)
-- p.add_key_binding("Ctrl+p", "copyFullPath", copyFullPath)
-- p.add_key_binding("Ctrl+s", "copySubtitle", copySubtitle)
-- p.add_key_binding("Ctrl+d", "copyDuration", copyDuration)
-- p.add_key_binding("Ctrl+m", "copyMetadata", copyMetadata)
