...
| `secrets/legacy.yaml` | `freshrss` | Retained FreshRSS configuration pending rotation or removal | None | none |
| `secrets/legacy.yaml` | `karakeep` | Retained Karakeep configuration pending rotation or removal | None | none |
| `secrets/legacy.yaml` | `minifluxOidcSecret` | Retained Miniflux OIDC secret pending rotation or removal | None | none |
